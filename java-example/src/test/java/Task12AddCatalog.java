    ...
    public static void stop() {
        ...
        public void login() {
            ...
            public void Task12Catalog() {
                ...
                driver.findElement(By.cssSelector("label:nth-child(3) > input[type=radio]")).click();  //селектор исправлен
                driver.findElement(By.name("name[en]")).sendKeys(nameProduct);
                driver.findElement(By.name("code")).sendKeys("12345");
                driver.findElement(By.cssSelector("input[name=\"categories[]\"]")).click(); //селектор исправлен
                driver.findElements(By.cssSelector("input[name=\"categories[]\"]")).get(1).click(); //селектор исправлен

                driver.findElements(By.cssSelector("input[name=\"product_groups[]\"]")).get(0).click(); //селектор исправлен
                ...
                driver.findElement(By.cssSelector("select[name=sold_out_status_id] > option:nth-child(3)")).click(); //селектор исправлен
                ...
                driver.findElement(By.cssSelector("select[name=manufacturer_id] > option:nth-child(2)")).click(); //селектор исправлен
                ...
                driver.findElement(By.cssSelector("select[name=purchase_price_currency_code] > option:nth-child(2)")).click();  //селектор исправлен
